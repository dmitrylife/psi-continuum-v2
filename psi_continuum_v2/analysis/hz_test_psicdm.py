...
Outputs:
- results/figures/hz/hz_psicdm_test.png        (H(z) + models comparison)
- results/figures/hz/hz_psicdm_chi2_eps_scan.png
- results/tables/hz/hz_psicdm_chi2.txt         (χ² for ΛCDM and ΨCDM scan)
"""
...
def main():
    ...
    fig_dir = results_dir / "figures" / "hz"
    ...
    print(
        f"H(z) best ΨCDM: eps0 = {best_eps:.4g}, χ² = {best_chi2:.2f}, "
        f"χ²/dof = {red_chi2_best:.3f}"
    )
    print(f"Δχ² = {best_chi2 - chi2_lcdm:.3f}")

    # ------------------------------------------------------------------
    # 4. Figure: H(z) + model curves
    # ------------------------------------------------------------------
